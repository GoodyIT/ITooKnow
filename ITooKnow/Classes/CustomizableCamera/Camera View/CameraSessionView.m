...
@interface CameraSessionView () <CaptureSessionManagerDelegate>
{
    ...
    BOOL isHideDismissBtn, isHideToggleBtn;
...
-(void)composeInterface {
    ...
    if (_topBarView) {
        ...
        if (topBarBackgroundColor != nil) {
            _topBarView.backgroundColor = topBarBackgroundColor;
        }
        ...
        if (_cameraToggle  && !isHideToggleBtn) {
        ...
        if (_cameraDismiss  && !isHideDismissBtn) {
...
{
    topBarBackgroundColor = topBarColor;
